 ...
 */
package fr.formation.youtube.dao.impl.spring.commons;
 ...
 * 
 */
// definition du contexte Spring par @Configuration
@Configuration
@ComponentScan(basePackages={"fr.formation.youtube.dao"} ) // Packages where to search the components
